...
def test_encode():
    pycocorools_encoded_mask = mask.encode(binary_mask)
    python_encoded_mask = encode_binary_mask(binary_mask)
    assert python_encoded_mask == pycocorools_encoded_mask


def test_decode():
    pycocorools_encoded_mask = mask.encode(binary_mask)
    python_decoded_mask = decode_coco_rle(pycocorools_encoded_mask)
